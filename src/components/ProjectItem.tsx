      ...
      >
        {repo.homepage
          ? <a
            ...
            bg-third rounded-br-[0.6rem] ease-out duration-[1s]"
          >
            Hosting 🔥
          </a>
          : <></>}
        {isShowingDescription
          ...
          <>
            <m.p
              className="theme-text text-center"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <m.a
              ...
              animate={{ opacity: 1 }}
              transition={{ ease: "easeOut", duration: 1.5 }}
              className="theme-text absolute self-center bottom-[20px] text-[0.8rem] hover:text-sky transition-all duration-500 ease-out"
            >
              Visit Github repository
            </m.a>
          </>
          : <m.span
            className="projectItem-title theme-text self-center capitalize font-bold text-[1.2rem]"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ ease: "easeOut", duration: 1.5 }}
          >
